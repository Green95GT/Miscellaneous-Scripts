...
void output_solution_sys(char *, double *, double **, int, int, double);
...
int main(int argc, char *argv[])
{
	...
	for (i = 0; i < N; i++)                                                      //memory allocation for matrix                               
	{                                                                                                            
    ...
    output_solution_sys("hyperb",x,v_old,N,0,time);                                                                                   //Number goes with file index - Ex: hyperb-0, hyperb-1, ...
	ip = 1;
    ...
    while (time < 1.0)
	{
	   ...
	   {
           output_solution_sys("hyperb",x,v_mid,N,ip,time);
           ip++;
       }
    }
    system("PAUSE");
